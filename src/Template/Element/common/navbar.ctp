<nav id="nav-3">
	<?php echo $this->Html->link('About',['controller' => 'Product', 'action' => 'index', '_full' => true],['class' => 'link-3']) ?>
	<?php echo $this->Html->link('Prodtype',['controller' => 'Product', 'action' => 'prodtype', '_full' => true],['class' => 'link-3']) ?>
	...
	<?php echo $this->Html->link('Contact',['controller' => 'Product', 'action' => 'contact', '_full' => true],['class' => 'link-3']) ?>
