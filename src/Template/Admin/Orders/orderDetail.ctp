            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody class="btn-icon-pg my-btn-icon-pg don-hang">
                <tr>
                  <td>1</td>
                  <td>Đồng Chí Tuấn</td>
                  <td>387/3 BIS Nguyễn Trãi, Phường Nguyễn Cư Trinh, Quận 1</td>
                  <td>0909842411</td>
                  <td>dongchituankakaka@gmail.com</td>
                  <td>Giao vào thứ 6 ngày 13/11/2017</td>
                  <td class="o-giua">
                            ...
                            <table class="table table-bordered table-striped">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td>1</td>
                                  <td>VERSACE WOMEN'S DV-25 ROUND LADY</td>
                                  <td>VERSACE</td>
                                  <td>6,300,000</td>
                                  <td>1</td>
                                  <td>6,300,000</td>
                                ...
                                <tr>
                                  <td>1</td>
                                  <td>1</td>
                                  <td>VIRTUOSO VIII T10GD001-SB1</td>
                                  <td>BOVET</td>
                                  <td>6,300,000</td>
                                  <td>2</td>
                                  <td>12,600,000</td>
                ...
                <tr>
                  ...
                  <td class="o-giua">
                    ...
                    <button class="btn tip-top" data-original-title="Đã Giao Hàng"><ul><li><i class="icon-road"></i></li></ul></button>
                    <button class="btn tip-top" data-original-title="Xóa Đơn Hàng"><ul><li><i class="icon-repeat"></i></li></ul></button>
                  </div>

                  </td>
                  <td class="o-giua"><ul><li><i class="icon-remove tip-top" data-original-title="Hiện Có"></i></li></ul></td>
                </tr>
