...
<div id="content">
  <div id="content-header">
    ...
    <div class="widget-content"><a href="#them-dong-ho" data-toggle="modal"> <button class="btn tip-top btn-icon-pg my-plus-btn-icon-pg" data-original-title="Thêm Sản Phẩm"><ul><li><i class="icon-plus"></i>Thêm Sản Phẩm </li></ul></button> </a>
                      ...
                      <div class="modal-body">
                        <form action="#" method="get" class="form-horizontal">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <textarea class="span3" placeholder="Thông Tin Sản Phẩm" ></textarea>
                            </div>
                          </div>
                        </form>
                      </div>
